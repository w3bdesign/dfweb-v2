      ...
      {projects.map(
        ({
          ...
          filter === category && (
            <div
              key={id}
              className="p-6 text-lg text-black transition duration-500 ease-in-out bg-white rounded shadow xl:p-12 lg:p-12 md:p-12 hover:bg-gray-200 transform-gpu hover:-translate-y-2"
            >
